...
from pythondjango.conftest import client_com_usuario_logado, usuario_logado
...
def test_nome_usuario__logado_disponivel(resp_home_com_usuario_logado, usuario_logado):
